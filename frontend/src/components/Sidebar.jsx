...
const Sidebar = () => {
  ...
  return (
    <aside className="h-full w-20 lg:w-72 rounded-xl border-r border-base-300 flex flex-col transition-all duration-200">
      <div className="border-b border-base-300 w-full p-5">
        <div className="flex items-center gap-2">
          <Ghost className="size-6 text-pink-600" />
        ...
        <div className="mt-3 hidden lg:flex items-center gap-2">
          <label className="cursor-pointer flex items-center gap-2">
            ...
            />
            <span className="text-sm text-pink-600"> Active boo-mates</span>
          </label>
          ...
          >
            <div className="relative mx-auto lg:mx-0">
              ...
              {activeUsers.includes(user._id) && (
                <span
                  className="absolute bottom-0 right-0 size-3 bg-pink-600 
